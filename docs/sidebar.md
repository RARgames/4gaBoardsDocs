...
1. You can change sidebar width inside [personal settings](./settings.md).
...
3. You can edit project/board within sidebar using a three-dot menu (see [project](./project.md) and [board](./board.md)).
