...
As an administrator, you have control over users information. When you click on the pencil icon, you can access the all of the personal [settings](./settings.md)  of each individual user. You can change them all without knowing their current password. Pretty handy! You can also check account activity — including when the user account was created and when the user’s information was last updated (for example, after a password change).
